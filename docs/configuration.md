...
| `allow_unverified_build` | `false` | Developer override permitting an unsupported KSA build to proceed to API checks; behavioral compatibility remains unverified |
